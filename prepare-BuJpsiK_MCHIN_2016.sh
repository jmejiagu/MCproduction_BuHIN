...
curl -s --insecure https://raw.githubusercontent.com/jmejiagu/MCproduction_BuHIN/main/$pyfile --retry 2 --create-dirs -o Configuration/GenProduction/python/$pyfile
